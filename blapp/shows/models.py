...
class Show(models.Model):
    ...
    contact_person_email_address = NameField(
        verbose_name=_("contact person email address"), blank=True
    )
    contact_person_phone_number = NameField(
        verbose_name=_("contact person phone number"), blank=True
    )
    contact_person_comment = DescriptionField(
        verbose_name=_("contact person comment"), blank=True
    )
