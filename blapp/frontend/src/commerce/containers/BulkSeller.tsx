...
const mapDispatchToProps = (dispatch: Dispatch, ownProps: any) => ({
  ...
  //@ts-ignore
  retryAllFailedPurchases: () => dispatch(actions.retryAllFailedPurchases()),
})
        ...
        <Container fluid style={{marginTop: '15px'}}>
          <Row>
            ...
            <Col sm={4}>
              ...
              <p></p>
              {R.values(this.props.failedPurchases).length ? <>
                <h3>Misslyckade köp</h3>
                <Button block color="warning" onClick={this.props.retryAllFailedPurchases}>Försök igen</Button>
                <Table size='sm'>
                  <thead>
                    <tr>
                      <th>Person</th>
