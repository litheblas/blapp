...
class Event(models.Model):
    ...
    signup_deadline = models.DateTimeField(
        verbose_name=_("signup deadline"), null=True, blank=True)
    ...
    contact_person = models.TextField(verbose_name=_(
        "contact person information"), null=True, blank=True)
    contact_mail = models.TextField(verbose_name=_(
        "contact mail information"), null=True, blank=True)
    contact_phone = models.TextField(verbose_name=_(
        "contact phone information"), null=True, blank=True)
    rating = models.TextField(verbose_name=_(
        "rating"), null=True, blank=True)
    price = models.TextField(verbose_name=_(
        "price"), null=True, blank=True)
